...
int     apply_locus_constraints(map<int, CSLocus *> &, PopMap<CSLocus> *, const map<int, pair<int, int> > &, ofstream &);
int     prune_polymorphic_sites(map<int, CSLocus *> &, PopMap<CSLocus> *, PopSum<CSLocus> *, const map<int, pair<int, int> > &, map<int, set<int> > &, set<int> &, ofstream &);
...
HapStat *haplotype_amova(map<int, int> &, const map<int, pair<int, int> > &, Datum **, LocSum **, vector<int> &);
...
double   haplotype_d_est(const map<int, pair<int, int> > &, Datum **, LocSum **, vector<int> &);
LocStat *haplotype_diversity(int, int, Datum **);

int  write_sql(map<int, CSLocus *> &, PopMap<CSLocus> *);
int  write_fst_stats(vector<pair<int, string> > &, const map<int, pair<int, int> > &, map<int, CSLocus *> &, PopMap<CSLocus> *, PopSum<CSLocus> *, ofstream &);
...
int  write_genepop(map<int, CSLocus *> &, PopMap<CSLocus> *, PopSum<CSLocus> *, const map<int, pair<int, int> > &, map<int, string> &);
int  write_genepop_ordered(map<int, CSLocus *> &, PopMap<CSLocus> *, PopSum<CSLocus> *, const map<int, pair<int, int> > &, map<int, string> &, ofstream &);
int  write_structure(map<int, CSLocus *> &, PopMap<CSLocus> *, PopSum<CSLocus> *, const map<int, pair<int, int> > &, map<int, string> &);
int  write_structure_ordered(map<int, CSLocus *> &, PopMap<CSLocus> *, PopSum<CSLocus> *, const map<int, pair<int, int> > &, map<int, string> &, ofstream &);
int  write_phase(map<int, CSLocus *> &, PopMap<CSLocus> *, PopSum<CSLocus> *, const map<int, pair<int, int> > &, map<int, string> &);
int  write_fastphase(map<int, CSLocus *> &, PopMap<CSLocus> *, PopSum<CSLocus> *, const map<int, pair<int, int> > &, map<int, string> &);
int  write_beagle(map<int, CSLocus *> &, PopMap<CSLocus> *, PopSum<CSLocus> *, const map<int, pair<int, int> > &, map<int, string> &);
int  write_beagle_phased(map<int, CSLocus *> &, PopMap<CSLocus> *, PopSum<CSLocus> *, const map<int, pair<int, int> > &, map<int, string> &);
int  write_plink(map<int, CSLocus *> &, PopMap<CSLocus> *, PopSum<CSLocus> *, const map<int, pair<int, int> > &, map<int, string> &);
int  write_hzar(map<int, CSLocus *> &, PopMap<CSLocus> *, PopSum<CSLocus> *, const map<int, pair<int, int> > &, map<int, string> &);
int  write_treemix(map<int, CSLocus *> &, PopMap<CSLocus> *, PopSum<CSLocus> *, const map<int, pair<int, int> > &, map<int, string> &);
int  write_phylip(map<int, CSLocus *> &, PopMap<CSLocus> *, PopSum<CSLocus> *, const map<int, pair<int, int> > &, map<int, string> &);
int  write_fullseq_phylip(map<int, CSLocus *> &, PopMap<CSLocus> *, PopSum<CSLocus> *, const map<int, pair<int, int> > &, map<int, string> &);
