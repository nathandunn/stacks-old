...
int main (int argc, char* argv[]) {
    ...
    map<int, int> len_buckets, snp_buckets;
	...
	//
	four_gamete_test(in_path + files[i].second, psum, len_buckets, snp_buckets);
    ...
    //
    log_fh << "# Distribution of haplotype block lengths.\n";
    map<int, int>::iterator buck_it;
    for (buck_it = len_buckets.begin(); buck_it != len_buckets.end(); buck_it++)
    ...
    //
    log_fh << "\n\n"
	   << "# Distribution of SNP counts per haplotype block.\n";
    for (buck_it = snp_buckets.begin(); buck_it != snp_buckets.end(); buck_it++)
	log_fh << buck_it->first << "\t" << buck_it->second << "\n";
...
four_gamete_test(string path, PhasedSummary *psum, map<int, int> &len_buckets, map<int, int> &snp_buckets)
{
    ...
    //
    fh << "\n\n"
       << "# Distribution of haplotype block lengths.\n";
    map<int, int>::iterator buck_it;
    for (buck_it = buckets.begin(); buck_it != buckets.end(); buck_it++) {
	fh << buck_it->first << "\t" << buck_it->second << "\n";

	len_buckets[buck_it->first] += buck_it->second;
    }
    ...
    fh << "\n\n"
       << "# Distribution of SNP counts per haplotype block.\n";
    for (buck_it = snps.begin(); buck_it != snps.end(); buck_it++) {
	fh << buck_it->first << "\t" << buck_it->second << "\n";

	snp_buckets[buck_it->first] += buck_it->second;
    }
