...
const double chisq_crit_values[4][10] = {
    ...
    {0.46, 1.32, 1.64, 2.07, 2.71, 3.84,  6.63,  7.88,  10.83,  12.12},
    {1.39, 2.77, 3.22, 3.79, 4.61, 5.99,  9.21, 10.60,  13.82,  15.20},
    {2.37, 4.11, 4.64, 5.32, 6.25, 7.81, 11.34, 12.84,  16.27,  17.73}
};
